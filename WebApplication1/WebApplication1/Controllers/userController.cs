...
namespace WebApplication1.Controllers
{
    public class userController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,full_name,password,role")] user user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,full_name,password,role")] user user)
        {
            if (ModelState.IsValid)
            {
